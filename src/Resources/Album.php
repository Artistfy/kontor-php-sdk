...
class Album
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            Helper::mapIfNotNull(Arr::get($data, 'price_code.code'), fn(string $code) => Price::fromCode($code)),
            Helper::mapIfNotNull(Arr::get($data, 'price_code_itunes.name'), fn(string $name) => iTunesPrice::fromName($name)),
            Arr::get($data, 'genres'),
